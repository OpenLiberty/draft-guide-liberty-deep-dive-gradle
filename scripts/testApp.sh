...
curl -k --user bob:bobpwd https://localhost:9443/metric?scope=application | grep 'application_addSystemClient_total 0\|application_addSystem_total 1\|application_updateSystem_total 1\|application_removeSystem_total 1' || exit 1
