...
Podman must be installed before you start the **Persisting Data** module. For installation instructions, refer to the https://podman.io/getting-started/installation[official Podman documentation^]. You'll build and run the microservices in containers.
...
In this workshop, the Open Liberty Starter is used to create the starting point of the application. Gradle is used as the selected build tool and the application uses of Jakarta EE 10 and MicroProfile 6.
...
* Under Java SE Version select: `21`
